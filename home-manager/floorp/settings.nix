      ...
      profiles =
        ...
        in
        {
          default = {
            ...
            search = {
              force = true;
              default = "Startpage"; # DuckDuckGo
              privateDefault = "Startpage"; # DuckDuckGo
            };
